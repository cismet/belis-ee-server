...
public class EntityComparator implements Comparator<BaseEntity>, Serializable {
    ...
    public EntityComparator(Comparator<Leuchte> leuchteComparator) {
...
//        }
        int result = compareImpl(o1, o2);
        //System.out.println("result: "+result);
        return result;
    }

    private int compareImpl(BaseEntity o1,BaseEntity o2){
        if (o1 != null && o2 != null) {
            if (o1 instanceof Leuchte) {
                ...
                if (o2 instanceof Standort) {
                    if (o1.equals(o2)) {
                        ...
                        return 1;
                    } else if (((Standort) o1).getStrassenschluessel() != null && ((Standort) o2).getStrassenschluessel() != null) {
                        int result = CriteriaStringComparator.getInstance().compare(((Standort) o1).getStrassenschluessel(), ((Standort) o2).getStrassenschluessel());
                        ...
                        if (result == 0) {
                            ...
                            if (((Standort) o1).getKennziffer() != null && ((Standort) o2).getKennziffer() != null) {
                                result = CriteriaStringComparator.getInstance().compare(((Standort) o1).getKennziffer(), ((Standort) o2).getKennziffer());
                                if (result == 0) {
                                    System.out.println("Kennziffern sind gleich");
                                    if (((Standort) o1).getLaufendeNummer() != null && ((Standort) o2).getLaufendeNummer() != null) {
                                        result = ((Standort) o1).getLaufendeNummer().compareTo(((Standort) o2).getLaufendeNummer());
                                        if (result == 0) {
                ...
                } else if (o2 instanceof Standort || o2 instanceof Leuchte || o2 instanceof Leitung || o2 instanceof Schaltstelle) {
                    return -1;
                } else {
                    return 1;
                }
                ...
                } else if (o2 instanceof Standort || o2 instanceof Leuchte || o2 instanceof Leitung || o2 instanceof Schaltstelle || o2 instanceof Mauerlasche) {
                    return -1;
                } else {
                    return 1;
                }
